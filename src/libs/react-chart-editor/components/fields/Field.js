...
class Field extends Component {
  render() {
    ...
    const showFieldTooltips = !!tooltip || this.context.showFieldTooltips;
    let tooltipText = this.context.attr;
    if (tooltip) {
      tooltipText = tooltip;
    } else if (this.context.description) {
      tooltipText += ' – ' + this.context.description.replace(/`/g, '"').replace(/\*/g, '"');
    }
