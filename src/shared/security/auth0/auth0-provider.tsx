...
import { configureSecurityInterceptor, configureErrorInterceptor } from '../../services/Api';
import SupersetClient from '../superset/superset-client';
  ...
  useEffect(() => {
    (async (): Promise<void> => {
      try {
        ...
        const supersetClient = new SupersetClient(client, { cacheLocation: 'localstorage', useRefreshTokens: true });
        configureSecurityInterceptor(client, supersetClient);
        configureErrorInterceptor(client, supersetClient);
